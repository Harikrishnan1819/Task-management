                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="task" class="form-control" placeholder="Task_Description">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Steps:</strong>
                            <textarea class="form-control" style="height:150px" name="task_descripton" placeholder="Steps"></textarea>
                        </div>
                    </div>                    
